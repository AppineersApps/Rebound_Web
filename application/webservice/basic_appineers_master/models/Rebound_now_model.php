...
class Rebound_now_model extends CI_Model
{
/**
...
return $return_arr;
 ...
 public function update_rebound_now($params_arr = array(), $where_arr = array())
    {
        try
        {
            $result_arr = array();
            ...
            $this->db->set($this->db->protect("dtRebount_now_active_UpdatedAt"), $params_arr["_dtaddedat"], FALSE);
...
public function get_users_list_details($arrParams = '')
{
	...
	}else
	{
		...
		$strWhere3 = "dtRebount_now_active_UpdatedAt BETWEEN '".$date2."' AND '".$date1."'";
		if (isset($strWhere3) && $strWhere1 != "")
		{
