...
class Rebound_now extends Cit_Controller
{
     ...
     public function __construct()
    {
        ...
        $this->single_keys = array(
            "get_rebound_users_list_details",
        );
        ...
        $this->load->model('rebound_now_model');
     ...
     */
    public function start_rebound_now($request_arr = array(), $inner_api = FALSE)
    {
   ...
   { 
		try
		{
            ...
            $input_params = $this->update_rebound_now($input_params);
  ...
  /**
     ...
     */
    public function update_rebound_now($input_params = array())
    {
        ...
        try
        {
            ...
            $this->block_result = $this->rebound_now_model->update_rebound_now($params_arr, $where_arr);
        }
        catch(Exception $e)
        {
            $success = 0;
        ...
        $input_params["update_rebound_now"] = $this->block_result["data"];
     ...
     public function is_logged_in($input_params = array())
    {
        ...
        try
        {
            ...
            $cc_lo_0 = (empty($input_params["update_rebound_now"]) ? 0 : 1);
            $cc_ro_0 = 1;
    ...
    public function get_users_list_details($input_params = array())
    {
        ...
        try
        {
           ...
           /* $arrParams['search_radius'] = isset($input_params["search_radius"]) ? $input_params["search_radius"] : "";*/
            ...
            $this->block_result = $this->rebound_now_model->get_users_list_details($arrParams);
    ...
    public function get_users_connection_details($user_id = '',$connection_id='')
    {
        ...
        try
        {
            ...
            $this->block_result = $this->rebound_now_model->get_users_connection_details($user_id,$connection_id);
