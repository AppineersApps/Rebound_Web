 ...
 *
 * @path application\webservice\influencer\controllers\Influencer_list.php
 *
 * @version 4.4
 *
 * @author CIT Dev Team
...
class Influencer_list extends Cit_Controller
{
     ...
     */
    public function rules_influencer_list($request_arr = array())
    {
         $valid_arr = array(            
            "user_id" => array(
                array(
    ...
    public function rules_update_influencer($request_arr = array())
    {
         ...
         $valid_arr = array(            
            "influencer_code" => array(
                array(
                    "rule" => "required",
                    "value" => TRUE,
                    "message" => "influencer_code_required",
                )
            ),
            "user_id" => array(
                array(
    ...
    public function start_influencer_list($request_arr = array(), $inner_api = FALSE)
    {
       //print_r($request_arr);
        ...
        switch ($method) {
        case 'GET':
           $output_response =  $this->get_influencer($request_arr);
           return  $output_response;
           break;
        case 'PUT':
           $output_response =  $this->update_influencer($request_arr);
           return  $output_response;
           break;
        }
    }
     public function get_influencer($request_arr)
    {
        //print_r($request_arr);//"influencer_id_required
         try
        {
            $validation_res = $this->rules_influencer_list($request_arr);
            ...
            $input_params = $this->get_influencer_list_v1($input_params);
     ...
     */
    public function get_influencer_list_v1($input_params = array())
    {
       // print_r($input_param); // no states found
        ...
        try
        {
                $this->block_result = $this->influencer_type_list_model->influencer_list();
        ...
        $input_params["get_influencer_list_v1"] = $this->block_result["data"];
    ...
    public function condition($input_params = array())
    {
        ...
        try
        {
            ...
            $cc_lo_0 = (empty($input_params["get_influencer_list_v1"]) ? 0 : 1);
            $cc_ro_0 = 1;
     ...
     public function update_influencer($request_arr)
    {
        //print_r($request_arr);
         try
        {
            $validation_res = $this->rules_update_influencer($request_arr);
            if ($validation_res["success"] == "-5")
            {
                if ($inner_api === TRUE)
                {
           ...
           $input_params = $this->set_influencer($input_params);
            ...
            {
                $output_response = $this->set_influencer_finish_success_1($input_params);
                return $output_response;
            }
        }
        catch(Exception $e)
     ...
     public function set_influencer($input_params = array())
    {
        ...
        try
        {
            ...
            if (!$this->block_result["success"])
            {
                throw new Exception("influencer updation failed.");
            }
        ...
        $input_params["update_influencer"] = $this->block_result["data"];
    ...
    public function is_set($input_params = array())
    {
        ...
        try
        {
            ...
            $cc_lo_0 = (empty($input_params["update_influencer"]) ? 0 : 1);
            $cc_ro_0 = 1;
     ...
     /**
     * set_influencer_finish_success method is used to process finish flow.
     * @created priyanka chillakuru | 18.09.2019
     * @modified priyanka chillakuru | 18.09.2019
     * @param array $input_params input_params array to process loop flow.
     * @return array $responce_arr returns responce array of api.
     */
    public function set_influencer_finish_success($input_params = array())
    {
     ...
     * @return array $responce_arr returns responce array of api.
     */
    public function set_influencer_finish_success_1($input_params = array())
    {
        //print_r($input_params);exit;
        $setting_fields = array(
            "success" => "0",
            "message" => "Not set influencers",
        );
        $output_fields = array();
  ...
  /*    print_r($input_params);
      ...
      */
        $setting_fields = array(
            "success" => "1",
            "message" => "Get influencers list fetched successfully.",
            //"data" => $input_params
        );
       ...
       $ouput_aliases = array(
            "get_influencer_list_v1" => "get_influencers_list",
        ...
        $func_array["function"]["name"] = "get_influencer_list_v1";
    ...
    public function mod_influencer_finish_success_1($input_params = array())
    {
        ...
        $func_array["function"]["name"] = "get_influencer_list_v1";//Function name
        $func_array["function"]["multiple_keys"] = $this->multiple_keys;
