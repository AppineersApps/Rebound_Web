...
return $return_arr;
    ...
    public function prepareWhere($input_params = array())
    {
        $where = "(m.iSenderId = '".$input_params['user_id']."' OR m.iReceiverId = '".$input_params['user_id']."') ";
        $return_arr['where_clause'] = $where;
        return $return_arr;
    }
