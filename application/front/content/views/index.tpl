                        ...
                        <div class="row d-flex align-items-center">
                            <div class="col-lg-6 col-md-9 ">
                                <div class="hero__caption">
                                    ...
                                    <h1 data-animation="fadeInUp" data-delay=".6s">Get Connected <br>with Rebound Mobile App</h1>
                                    <p data-animation="fadeInUp" data-delay=".8s">Like a profile and let your likes message you or when someone likes you, get a chance to message someone without matching. </p>
                                    <!-- Slider btn -->
                        ...
                        <div class="row d-flex align-items-center">
                            ...
                            <div class="col-lg-6 col-md-9 ">
                                <div class="hero__caption">
                                    ...
                                    <p data-animation="fadeInUp" data-delay=".8s">A platform where the users can connect in one click.</p>
                                    <!-- Slider btn -->
                                   <div class="slider-btns">
                                        <!-- Hero-btn -->
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="single-features mb-70">
                                    ...
                                    <div class="features-caption">
                                        <h3>Like Profile and chat</h3>
                                        <p>User can like a profile and subscribed users can directly send a message.</p>
                                    </div>
                                </div>
                            </div>
                             <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="single-features mb-70">
                                    ...
                                    <div class="features-caption">
                                    	 <h3>Get a chance to message someone without matching</h3>
                                        <p>Instantly message them without waiting for the partner to like you back.</p>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="single-features mb-70">
                                    ...
                                    <div class="features-caption">
                                       <h3>Search nearby users</h3>
                                        <p>Search nearby user according to your preferences and get in touch.
</p>
                                    </div>
                                </div>
                            </div>
                             <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="single-features mb-70">
                                    ...
                                    <div class="features-caption">
                                    	<h3>Rebound Now</h3>
                                        <p>Find active users who have accessed this feature and connect with them instantly.</p>
               ...
               <div class="row d-flex justify-content-center">
                    <div class="col-lg-6">
                        <div class="section-tittle text-center">
                            <h2>How Can We Help You<br>with Rebound!</h2>
                        </div>
                    </div>
                </div>
                <!-- Section caption -->
                <div class="row">
                    <div class="col-lg-6">
                        <div class=" text-center mb-30">
                           <div class="et_pb_code_inner"><iframe width="560" height="315" src="https://www.youtube.com/embed/dY5A1OW0s_w" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
...
<p style="color:#000!important;">Get chance to connect with someone!</div>
                        </div>
                    </div> 
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-8">
                        <div class="single-cases-info mb-30">
                            <h3>Rebound Apps<br> Screenshot</h3>
                            <p>A platform where users can connect in one click.</p>
                        </div>
                    </div>
                    <!-- OwL -->
                    <div class="col-xl-8 col-lg-8 col-md-col-md-7">
                        <div class="app-active owl-carousel"> 
                            ...
                            <div class="single-cases-img">
                                <img src="<%$this->config->item('site_url')%>public/upload/website_images/gallery/App7.png" alt="">
                            </div> 
                            <div class="single-cases-img">
                                <img src="<%$this->config->item('site_url')%>public/upload/website_images/gallery/App8.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
...
var scrollSrc = "<%$this->config->item('site_url')%>public/upload/website_images/logo/logo_white.png";
